...
class MantraAlbum(models.Model):
  ...
  album_cover_image = models.FileField(upload_to='mantra_album_cover_image/')
...
class Mantra(models.Model):
  ...
  mantra_image = models.FileField(upload_to='mantra_image/')
  mantra_name = models.CharField(max_length=40, default=" ")
  artist = models.CharField(max_length=40, default=" ")
  media_file = models.FileField(upload_to='mantra_mp3/')
...
class MantraLyric(models.Model):
  ...
  mantra_lyric_image = models.FileField(upload_to='mantra_lyrics_image/')
  mantra_name = models.CharField(max_length=40, default=" ")
  artist = models.CharField(max_length=40, default=" ")
